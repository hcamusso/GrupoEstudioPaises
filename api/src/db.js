...
const {Country, Activity } = sequelize.models; // Destructuring !!!!!!!!!!!!!


// Aca vendrian las relaciones
// Product.hasMany(Reviews);
Country.belongsToMany(Activity, { through: 'country_activity' });// Muchos a muchos !!!
Activity.belongsToMany(Country, { through: 'country_activity' });// muchos a muchos !!!
